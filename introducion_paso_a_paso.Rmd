...
23 # 2/3
12 > 4 # 12 >= 4; 12 < 4; 12 <= 4 
!TRUE # (negación); TRUE & FALSE (and); TRUE | FALSE (oro)
```
...
* vectores 1D
* matrices 2D (Formado tabla)
* arrays nD

__Datos heterogéneos__:

* list 1D
* ```data.frames``` 2D (Formado BBDD habitual)
...
* Existen `packages` más rápidos como `data.table` y `dplyr`.

---

Del capitulo [Vocabulary](http://adv-r.had.co.nz/Vocabulary.html) de Advanced R.
